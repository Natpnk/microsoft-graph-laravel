...
use Microsoft\Graph\Model\{Directory, DriveItem, File, UploadSession};

class MicrosoftGraphStorageAdapter implements FilesystemAdapter {
    ...
    public function write(string $path, string $contents, Config $config): void {
        ...
        try {
            ...
            $this->graph->createRequest('PUT', $this->getDriveItemUrl($parentItem) . ":/$file_name:/content")
    ...
    public function readStream(string $path){
        ...
        try {
            ...
            $guzzle = new Guzzle();
            $response = $guzzle->request('GET', $download_url);
    ...
    public function delete(string $path): void {
        ...
        try {
            ...
            $this->graph->createRequest('DELETE', $this->getDriveItemUrl($path))->execute()->getBody();
    ...
    public function createDirectory(string $path, Config $config): void {
        ...
        try {
            ...
            $this->graph->createRequest('POST', $this->getChildrenUrl($path))->attachBody($body)->setReturnType(DriveItem::class)->execute();
    ...
    public function listContents(string $directory, bool $deep): iterable {
        ...
        try {
            ...
            $request = $this->graph->createCollectionRequest('GET', $path)->setReturnType(DriveItem::class);
    ...
    public function getFile(string $path): File {        
        return $this->graph->createRequest('GET', $path)->setReturnType(File::class)->execute();
    }

    public function getDirectory(string $path): Directory {
        return $this->graph->createRequest('GET', $path)->setReturnType(Directory::class)->execute();
    }

    public function getDriveItem(string $path): DriveItem {        
        return $this->graph->createRequest('GET', $path)->setReturnType(DriveItem::class)->execute();
    }
